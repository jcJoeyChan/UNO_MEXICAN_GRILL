...
- **The food is Tex-Mex, not authentic Mexican (user-confirmed 2026-09-02).** The restaurant's own menu says so — it lists a Tex-Mex Chili Burrito and a Tex-Mex Chili tostada salad. Never describe the food as "authentic", "real Mexican", or "traditional Mexican": that is a factual claim about the cuisine and it is not true. "Mexican" appears in the restaurant's name and that stays; the *food* is described as Tex-Mex. The genuine, verifiable differentiator to lead with instead is the tortillas — made from scratch on their own machine and baked when you order.
