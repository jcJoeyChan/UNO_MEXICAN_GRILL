...
- **Menu data provenance.** The full menu with prices was read from the live ChowBus store page, not supplied by hand; the phone number `(718) 470-2050` came from that same page. **Re-verify against the restaurant before launch** — prices and availability drift, and seasonal items (e.g. soups) were already showing sold-out.
