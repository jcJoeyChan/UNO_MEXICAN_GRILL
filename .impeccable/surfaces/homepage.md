...
- FIRST VIEWPORT: Sticky top bar (logo · Menu · Location · Order▾) over a mosaic of the real food photographs — one anchor tile (Spread2, the only image large enough to hold size) plus smaller tiles, none upscaled past its native pixels — with headline + one-line positioning, live open/closed status pill, and primary "Order Now ▾" + secondary "View Menu" in the lower third.
